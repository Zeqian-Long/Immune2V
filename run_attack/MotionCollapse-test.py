...
# image = Image.open("attacked/images/hike.jpg")
image = Image.open("data/random_gaussian/train.jpg")
# image = Image.open("swan_attacked.jpg")
...
save_video(video, "clean_ddd.mp4", fps=15, quality=5)
